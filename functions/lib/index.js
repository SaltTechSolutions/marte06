...
exports.notifyOnPackageChangeRequested = (0, firestore_1.onDocumentCreated)({ document: 'package_change_requests/{requestId}', region: 'europe-west1' }, async (event) => {
    ...
    if (!data)
        return;
    await sendPushToUser(data.memberId, 'Paket teklifin var', `${(_c = (_b = data.proposedSummary) === null || _b === void 0 ? void 0 : _b.packageName) !== null && _c !== void 0 ? _c : 'Yeni paket'} için bir teklif bekliyor.`, { screen: 'member/index' });
});
/**
...
exports.applyPackageChange = (0, firestore_1.onDocumentUpdated)({ document: 'package_change_requests/{requestId}', region: 'europe-west1' }, async (event) => {
    ...
    if (after.status === 'rejected') {
        await sendPushToUser(after.createdBy, 'Paket teklifi reddedildi', `${after.memberName}, ${(_f = (_e = after.proposedSummary) === null || _e === void 0 ? void 0 : _e.packageName) !== null && _f !== void 0 ? _f : 'önerilen paketi'} kabul etmedi.`);
        return;
    }
